...
input CategoryScalarWhereInput {
  ...
  category_id_gt: ID
  category_id_gte: ID
  category_id_contains: ID
  category_id_not_contains: ID
  category_id_starts_with: ID
  category_id_not_starts_with: ID
  category_id_ends_with: ID
  category_id_not_ends_with: ID
  name: String
  name_not: String
  name_in: [String!]
  name_not_in: [String!]
...
input ItemScalarWhereInput {
  ...
  price_gte: Int
  discounted_price: Int
  discounted_price_not: Int
  discounted_price_in: [Int!]
  discounted_price_not_in: [Int!]
  discounted_price_lt: Int
  discounted_price_lte: Int
  discounted_price_gt: Int
  discounted_price_gte: Int
  display: Boolean
  display_not: Boolean
